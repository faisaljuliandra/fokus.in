...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert('Goals', [
      ...
      { id: nanoid(), categoriesId: '-75aoJC7hwadrknBNLu3q', namaGoal: 'Menjadi Freelance Graphic Designer', deskripsiGoal: 'Belajar menjadi Graphic Designer', estimationTime: '6 bulan', createdAt: new Date(), updatedAt: new Date() },
